...
const FOOD_DB = [
  ...
  { name: "סטייק אנטריקוט", unit: "200 גרם", calories: 580, protein: 46, carbs: 0, fat: 44 },
  { name: "קבב בשר", unit: "שיפוד", calories: 180, protein: 11, carbs: 2, fat: 14 },
  { name: "פרגית בגריל", unit: "100 גרם", calories: 210, protein: 26, carbs: 0, fat: 12 },
  ...
  { name: "כריך ביצה", unit: "יחידה", calories: 290, protein: 14, carbs: 30, fat: 12 },
  { name: "כריך חומוס", unit: "יחידה", calories: 300, protein: 11, carbs: 38, fat: 11 },
  { name: "כריך גבינה צהובה", unit: "יחידה", calories: 310, protein: 15, carbs: 30, fat: 14 },
  { name: "כריך גבינה לבנה וירקות", unit: "יחידה", calories: 230, protein: 12, carbs: 30, fat: 7 },
  { name: "כריך חזה הודו", unit: "יחידה", calories: 280, protein: 22, carbs: 30, fat: 7 },
  { name: "כריך סלמון", unit: "יחידה", calories: 360, protein: 20, carbs: 31, fat: 18 },
  { name: "כריך שניצל", unit: "יחידה", calories: 480, protein: 26, carbs: 45, fat: 22 },
  { name: "בייגל עם גבינה", unit: "יחידה", calories: 360, protein: 14, carbs: 50, fat: 11 },
  { name: "קרואסון חמאה", unit: "יחידה", calories: 270, protein: 5, carbs: 26, fat: 16 },
  { name: "קרואסון שוקולד", unit: "יחידה", calories: 340, protein: 6, carbs: 35, fat: 19 },
  // טוסטים
  { name: "טוסט גבינה", unit: "יחידה", calories: 270, protein: 13, carbs: 28, fat: 12 },
  { name: "טוסט גבינה וירקות", unit: "יחידה", calories: 290, protein: 14, carbs: 30, fat: 12 },
  { name: "טוסט פיצה", unit: "יחידה", calories: 300, protein: 14, carbs: 32, fat: 13 },
  { name: "טוסט אבוקדו", unit: "יחידה", calories: 250, protein: 7, carbs: 24, fat: 14 },
  // חביתות
  { name: "חביתה מביצה אחת", unit: "מנה", calories: 95, protein: 7, carbs: 0.5, fat: 7 },
  { name: "חביתת ירק", unit: "מנה", calories: 200, protein: 13, carbs: 4, fat: 15 },
  { name: "חביתת גבינה", unit: "מנה", calories: 250, protein: 17, carbs: 2, fat: 19 },
  { name: "שקשוקה", unit: "מנה", calories: 280, protein: 14, carbs: 14, fat: 18 },
  // פסטות
  { name: "פסטה ברוטב עגבניות", unit: "צלחת", calories: 350, protein: 12, carbs: 60, fat: 7 },
  { name: "פסטה ברוטב שמנת", unit: "צלחת", calories: 520, protein: 14, carbs: 58, fat: 26 },
  { name: "פסטה בולונז", unit: "צלחת", calories: 480, protein: 24, carbs: 58, fat: 16 },
  { name: "פסטה ברוטב פסטו", unit: "צלחת", calories: 500, protein: 14, carbs: 56, fat: 24 },
  { name: "פסטה ברוטב אלפרדו", unit: "צלחת", calories: 540, protein: 18, carbs: 56, fat: 28 },
  { name: "מק אנד צ'יז", unit: "צלחת", calories: 500, protein: 18, carbs: 55, fat: 23 },
  { name: "רביולי", unit: "צלחת", calories: 400, protein: 16, carbs: 50, fat: 14 },
  { name: "לאפה עם קבב", unit: "מנה", calories: 650, protein: 32, carbs: 60, fat: 30 },
  { name: "גחנון", unit: "יחידה", calories: 360, protein: 7, carbs: 45, fat: 17 },
  { name: "חמין (צ'ולנט)", unit: "צלחת", calories: 550, protein: 30, carbs: 55, fat: 24 },
...
const FOOD_ALIASES = {
  ...
  "סטייק": "סטייק בקר",
  "אנטריקוט": "סטייק אנטריקוט",
  "סטייק אנטריקוט": "סטייק אנטריקוט",
  "קבב": "קבב בשר",
  "קבב בשר": "קבב בשר",
  "פרגית": "פרגית בגריל",
  "גחנון": "גחנון",
  ...
  "כריך טונה": "כריך טונה",
  "כריך ביצה": "כריך ביצה",
  "כריך חומוס": "כריך חומוס",
  "כריך גבינה צהובה": "כריך גבינה צהובה",
  "כריך גבינה": "כריך גבינה צהובה",
  "כריך גבינה לבנה": "כריך גבינה לבנה וירקות",
  "כריך הודו": "כריך חזה הודו",
  "כריך חזה הודו": "כריך חזה הודו",
  "כריך סלמון": "כריך סלמון",
  "כריך שניצל": "כריך שניצל",
  "כריך": "סנדוויץ גבינה",
  "בייגל": "בייגל עם גבינה",
  "קרואסון": "קרואסון חמאה",
  "קרואסון שוקולד": "קרואסון שוקולד",
  "טוסט": "טוסט גבינה",
  "טוסט גבינה": "טוסט גבינה",
  "טוסט ירקות": "טוסט גבינה וירקות",
  "טוסט פיצה": "טוסט פיצה",
  "טוסט אבוקדו": "טוסט אבוקדו",
  "חביתה מביצה": "חביתה מביצה אחת",
  "חביתת ירק": "חביתת ירק",
  "חביתת ירקות": "חביתת ירק",
  "חביתת גבינה": "חביתת גבינה",
  "שקשוקה": "שקשוקה",
  "פסטה ברוטב עגבניות": "פסטה ברוטב עגבניות",
  "פסטה אדומה": "פסטה ברוטב עגבניות",
  "פסטה ברוטב שמנת": "פסטה ברוטב שמנת",
  "פסטה שמנת": "פסטה ברוטב שמנת",
  "פסטה לבנה": "פסטה ברוטב שמנת",
  "פסטה בולונז": "פסטה בולונז",
  "בולונז": "פסטה בולונז",
  "פסטה פסטו": "פסטה ברוטב פסטו",
  "פסטה ברוטב פסטו": "פסטה ברוטב פסטו",
  "פסטה אלפרדו": "פסטה ברוטב אלפרדו",
  "אלפרדו": "פסטה ברוטב אלפרדו",
  "מק אנד צ'יז": "מק אנד צ'יז",
  "רביולי": "רביולי",
